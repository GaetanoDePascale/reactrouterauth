...
export default function DataComponent() {
    ...
    const onClickDetail = (item) => {
        setModal({ open: true, title: item.name, content: item.description });
    };
    ...
    return (
        <>
            <ol>
                <RecursiveComponent
                    key={data.id}
                    item={{ id: data.id, name: data.name, description: data.description }}
                    children={data.items}
            ...
            <Modal
                open={modal.open}
                title={modal.title}
                onCancel={() => setModal({ open: false, title: '', content: '' })}
                footer={[
                    <Button key='Close' onClick={() => setModal({ open: false, title: '', content: '' })}>
                        Close
                    </Button>,
                ]}
            >
